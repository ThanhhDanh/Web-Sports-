...
=============================================*/
    function thirdSlider() {
        $('.third-slider-active, .h7-slider-active')
            .slick({
                autoplay: false,
                autoplaySpeed: 10000,
                dots: false,
...
=============================================*/
    $('[data-countdown]').each(function () {
        ...
        $this.countdown(finalDate, function (event) {
            $this.html(
                event.strftime(
                    '<div class="time-count day"><span>%D</span>Days</div><div class="time-count hour"><span>%H</span>Hours</div><div class="time-count min"><span>%M</span>Min</div><div class="time-count sec"><span>%S</span>Sec</div>',
                ),
            );
        });
    });
